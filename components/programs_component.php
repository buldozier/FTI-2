            ...
            <div class="programs__slider__card">
              ...
              <div class="programs__slider__description">
                <ul>
                  ...
                  <li>
                    Использование уникального лабораторного оборудования и ядерно-физических установок в своих научных
                    проектах
                  </li>
            ...
            <div class="programs__slider__card">
              ...
              <div class="programs__slider__description">
                <ul>
                  ...
                  <li>Моделирование материалов с заданными свойствами для элементов электронной техники</li>
            ...
            <div class="programs__slider__card">
              ...
              <div class="programs__slider__description">
                <ul>
                  ...
                  <li>Моделирование биологических процессов и системы</li>
                  <li>
                    Управление состоянием живых систем, обеспечение их жизнедеятельности, а также поддержание
                    оптимальных условий трудовой деятельности человека
                  </li>
                </ul>
              </div>
              <div class="programs__slider__footer">
            ...
            <div class="programs__slider__card">
              ...
              <div class="programs__slider__description">
                <ul>
                  ...
                  <li>Управление процессами контроля качества</li>
                  <li>проведение исследований в области неразрушающего контроля</li>
                  <li>
                    Разработка приборов для контроля качества, а так же применение уже готовые соедств для контроля
            ...
            <div class="programs__slider__card">
              ...
              <div class="programs__slider__description">
                <ul>
                  ...
                  <li>Внедрение новых процессов для направленной модификации наноматериалов и наноструктур</li>
                  <li>Исследование свойств нанообъектов и изделий на их основе</li>
            ...
            <div class="programs__slider__card">
              ...
              <div class="programs__slider__description">
                <ul>
                  ...
                  <li>Использование квантового компьютера для создания алгоритмов шифрования</li>
                  <li>
            ...
            <div class="programs__slider__card">
              ...
              <div class="programs__slider__description">
                <ul>
                  ...
                  <li>Разработка моделей и алгоритмов машинного обучения</li>
                  <li>Интеграция ML-решений в системы CRM и бизнес-процессов компании</li>
            ...
            <div class="programs__slider__card">
              ...
              <div class="programs__slider__description">
                <ul>
                  ...
                  <li>Анализ и совершенствование бизнес-процессов</li>
            ...
            <div class="programs__slider__card">
              ...
              <div class="programs__slider__description">
                <ul>
                  ...
                  <li>Проведение экспертизы инновационных проектов и объектов интеллектуальной собственности</li>
                  <li>Определение стратегий защиты интеллектуальной собственности</li>
            ...
            <div class="programs__slider__card">
              ...
              <div class="programs__slider__description">
                <ul>
                  ...
                  <li>Моделирование, синтез и исследование свойств материалов</li>
                  <li>Управление химическим производством</li>
                  <li>Работа на современном аналитическом оборудовании</li>
                  <li>Разработка новых методик анализа</li>
            ...
            <div class="programs__slider__card">
              ...
              <div class="programs__slider__description">
                <ul>
                  ...
                  <li>Обеспечение полного жизненного цикла аппаратуры собственного производства</li>
            ...
            <div class="programs__slider__card">
              ...
              <div class="programs__slider__description">
                <ul>
                  ...
                  <li>Исследование взаимодействия излучения с объектами живой и неживой природы</li>
                  <li>Моделирование и исследование процессов в ядерном реакторе и материалах</li>
            ...
            <div class="programs__slider__card">
              ...
              <div class="programs__slider__description__magistr">
                <p>
                  ...
                  архитектур и нейросетевых технологий. Часть времени посвящена изучению квантовых явлений, квантовых
                  алгоритмов и квантовых устройств. В рамках проведения научно-исследовательских работ магистры кафедры
            ...
            <div class="programs__slider__card">
              ...
              <div class="programs__slider__description__magistr">
                <p>
                  ...
                  любой сфере народного хозяйства. Полученные профессиональные компетенции в области организации
                  производства и технологического предпринимательства дают возможность выпускникам программы работать в
                  сфере малого бизнеса, самостоятельно организовать инновационное производство новой востребованной на
                  рынке продукции.
                </p>
              </div>
              <div class="programs__slider__footer__magistr">
            ...
            <div class="programs__slider__card">
              ...
              <div class="programs__slider__description__magistr">
                <p>
                  ...
                  материалов для электронной техники организованы в НОЦ «Наноматериалы и нанотехнологии», а также в
                  лабораториях институтов УрО РАН. Проектирование устройств микро- и наноэлектроники различного
                  назначения. Организация технологических процессов производства приборов и компонентной базы
                  электроники.
                </p>
              </div>
              <div class="programs__slider__footer__magistr">
            ...
            <div class="programs__slider__card">
              ...
              <div class="programs__slider__description__magistr">
                <p>
                  ...
                  электроники и импульсной энергетики. Проектирование и конструирование электронных приборов и
                  устройств. Разработка технологий производства установок вакуумной, плазменной, твердотельной,
            ...
            <div class="programs__slider__card">
              ...
              <div class="programs__slider__description__magistr">
                <p>
                  ...
                  современных материалов» ИФМ РАН с привлечением иностранных специалистов и специалистов профильных
                  промышленных предприятий. Практика и НИР организованы в лабораториях институтов УрО РАН и на
            ...
            <div class="programs__slider__card">
              ...
              <div class="programs__slider__description__magistr">
                <p>
                  ...
                  лечебных и реабилитационных процедур в медицинских центрах. Радиационные технологии в биомедицинской
                  инженерии на базе центра радиационной стерилизации. Обработка биомедицинской информации, создание и
            ...
            <div class="programs__slider__card">
              ...
              <div class="programs__slider__description__magistr">
                <p>
                  ...
                  назначения и радиофармацевтических препаратов. Модули специализации: <br />• Прикладная метрология
                  ионизирующего излучения<br />
                  • Ядерно-физические установки<br />
                  • Физика взаимодействия ионизирующего излучения с веществом и защита от ионизирующего излучения<br />
            ...
            <div class="programs__slider__card">
              ...
              <div class="programs__slider__description__magistr">
                <p>
                  ...
                  взаимодействия излучения с веществом. Подготовка высококвалифицированных специалистов в области
                  ядерной физики для предприятий атомной и оборонной промышленности, научно-исследовательских
                  организаций.
                </p>
              </div>
              <div class="programs__slider__footer__magistr">
            ...
            <div class="programs__slider__card">
              ...
              <div class="programs__slider__description__magistr">
                <p>
                  ...
                  организаций, выполняют собственные разработки. В образовательном и научном процессах задействованы
            ...
            <div class="programs__slider__card">
              ...
              <div class="programs__slider__description__magistr">
                <p>
                  ...
                  • Технологическая платформа «Замкнутый ядерный топливный цикл с реакторами на быстрых нейтронах»<br />
                  Траектории обучения:<br />

                  • Гидрометаллургия редкоземельных элементов (теория сорбционных процессов, технология редкоземельных
            ...
            <div class="programs__slider__card">
              ...
              <div class="programs__slider__description__magistr">
                <p>
                  ...
                  • Обеспечение экологической безопасности производств<br />
                  • Радиоэкологический мониторинг и радиохимический анализ.<br />
                  • Радиохимические технологии в ядерном топливном цикле.<br />
                  • Технологии производства радиоактивных изотопов.<br />
            ...
            <div class="programs__slider__card">
              ...
              <div class="programs__slider__description__magistr">
                <p>
                  ...
                  из них. Изучение физико-химических основ технологии получения материалов, исследования свойств
                  материалов, выявление закономерностей «состав-структура-свойство», моделирование и оптимизация
            ...
            <div class="programs__slider__card">
              ...
              <div class="programs__slider__description__magistr">
                <p>
                  ...
                  международных стандартов. Научные исследования в области метрологии, стандартизации, сертификации и
                  управления качеством. Все преподаватели специальных дисциплин являются практиками, участвующими в
                  разработке, внедрении и сертификации систем менеджмента качества, интегрированных систем менеджмента
            ...
            <div class="programs__slider__card">
              ...
              <div class="programs__slider__description__magistr">
                <p>
                  ...
                  Опыт работы в проектных командах. Практика и обучение на реальных кейсах инновационных проектов и
                  инновационных предприятий. Опыт работы в центре трансфера технологий и центре интеллектуальной
                  собственности УрФУ. Выпускники – специалисты в области предпринимательства, менеджмента и консалтинга,
            ...
            <div class="programs__slider__card">
              ...
              <div class="programs__slider__description__magistr">
                <p>
                  ...
                  методы зондовой микроскопии и нанолитографии. Студенты получат необходимые знания и умения по
                  разработке, нанообъектов различного назначения. Студенты овладеют методами численных расчетов и
                  моделирования свойств наноматериалов и нанообъектов, приобретут навыки применения прикладного
            ...
            <div class="programs__slider__card">
              ...
              <div class="programs__slider__description__magistr">
                <p>
                  ...
                  внедренческой деятельности в сфере социальной работы. Принятие оптимальных управленческих решений с
